...
void Cal(BigNum ini) {
	...
	x.print();
	A = BB;
	if(Zero(A,2) == 0) { printf("Ghost of Tanveer Ahsan!!!\n"); f = 1; }
	if(Zero(A,5) == 0) { printf("Ghost of Shahriar Manzoor!!!\n"); f = 1; }
	if(Zero(A,7) == 0)  { printf("Ghost of Adrian Kugel!!!\n"); f = 1; }
	if(Zero(A,11) == 0)  { printf("Ghost of Anton Maydell!!!\n"); f = 1; }
	if(Zero(A,15) == 0) { printf("Ghost of Derek Kisman!!!\n"); f = 1;  }
	if(Zero(A,20) == 0) {printf("Ghost of Rezaul Alam Chowdhury!!!\n"); f = 1; }
	if(Zero(A,28) == 0) { printf("Ghost of Jimmy Mardell!!!\n"); f = 1; }
	if(Zero(A,36) == 0) { printf("Ghost of Monirul Hasan!!!\n"); f = 1; }
	if(pf) {
